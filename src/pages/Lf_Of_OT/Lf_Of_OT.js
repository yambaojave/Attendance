...
const columns = [
  ...
  { id: "_OTID", label: "OTID", minWidth: 150 },
  { id: "_employee_id", label: "Employee ID", minWidth: 150 },
  { id: "_Name", label: "Name", minWidth: 150 },
  { id: "_Department", label: "Department", minWidth: 150 },
  { id: "_Section", label: "Section", minWidth: 150 },
  { id: "_Overtime_Date", label: "OT Date", minWidth: 150 },
  { id: "_Date_filed", label: "Date Filled In", minWidth: 150 },
  { id: "_Time_filed", label: "Time Filled", minWidth: 150 },
...
const Lf_Of_OT = () => {
  ...
  const CreateExcelFile = () => {
    if (rows.length === 0) {
      ...
      xlsx.utils.book_append_sheet(wb, ws, "LAteOTFile");

      xlsx.writeFile(wb, "LateOT.xlsx");
    }
  };
